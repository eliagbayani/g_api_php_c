...
/*
$results = $service->table->importRows($my_table, array());
*/

$url = "https://www.googleapis.com/fusiontables/v2/tables/import?name=eli_tbl2&key=AIzaSyCXt2WPrcQniaMomonEruEOi3EHYlGEi3U";
// $url = "https://www.googleapis.com/upload/upload/fusiontables/v2/tables/import?uploadType=resumable&key=AIzaSyCXt2WPrcQniaMomonEruEOi3EHYlGEi3U"
$response = run_curl($url);
// echo "<br>post response: <br>$response<br>";
// https://www.googleapis.com/fusiontables/v2/tables/import?name=eli_tbl2&key=AIzaSyCXt2WPrcQniaMomonEruEOi3EHYlGEi3U
...
function run_curl($url)
{
    ...
    curl_setopt($ch,CURLOPT_POSTFIELDS, "lname=eli");
